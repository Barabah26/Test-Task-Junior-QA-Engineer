...
**Test Case:**
Verify where password length validation is performed.
...
5. Enter `21233` in the password field.
6. Submit the registration form.
7. Inspect the request and response.

**Expected Result:**
The location of password validation is identified:

* frontend;
* backend;
* or both.

If a request is sent to the backend, verify whether the invalid password is rejected by the backend as well.

**Type:** Technical / Exploratory
**Priority:** Medium
